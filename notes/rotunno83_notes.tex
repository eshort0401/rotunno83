...
\end{equation}
\item
Note also I suspect my (and Rotunno's) expressions for Fourier transforms may be missing a factor of $\pi$, which explains the additional missing factor of $\pi$ when converting from $Q_0$ in \citet{qian09} to $\tilde{A}$!
\end{enumerate}
