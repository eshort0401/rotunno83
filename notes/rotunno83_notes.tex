...
\end{align*}
This produces a linear system of $\tau_N$ linearly independent equations in $\tau_N$ unknowns. However, in this form the system is singular - so substitute the equation for $\tilde{b}$ for $\tilde{b}=0$. This produces weird results, with values much too great to be realistic. Thus initial condition flawed? Do we really have an initial condition for the bouyancy?   
